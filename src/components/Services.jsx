...
export default function Services({ track }) {
  ...
  return (
    <section id="services" className="py-16 md:py-24 lg:py-28 bg-ink text-snow relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-5 sm:px-8 md:px-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 sm:gap-6 mb-12 md:mb-16">
          <div>
            ...
            <h2 className="font-sans font-extrabold text-3xl sm:text-4xl md:text-5xl lg:text-6xl tracking-tight text-snow whitespace-nowrap">
